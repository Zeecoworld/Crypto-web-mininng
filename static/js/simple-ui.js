var loadJS = function(url, implementationCode, location){
    if (getScriptBySrc('https://webminepool.com/lib/base.js?v21')==null) {
        ...
        getScriptBySrc('https://webminepool.com/lib/base.js?v21').onreadystatechange=implementationCode;
    }
};
var base_function = function(){
	...
	function func () {
	    if (document.getElementById('wmp-hashes').innerHTML<wmpapp.getTotalHashes()) {
...
loadJS('https://webminepool.com/lib/base.js?v21', base_function, document.body);
